#!/usr/bin/env python
# Lambda Handler: courses-talk-monitor.lambda_handler
...
TARGETS = [
    {
        "name": "Moodle",
        "uri": "http://courses.hotosm.org/",
        "component_id": "JHv8gQiZeRHC",
    },
    {
        "name": "Mumble",
        "uri": "http://talk.hotosm.org/mumble/1",
        "component_id": "VtIEmgYILfHc",
    },
]
API_EP = "https://status-admin.hotosm.org/api/v0"
